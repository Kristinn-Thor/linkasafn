...
const Footer = () => {
  ...
  return (
    <footer>
      <section>
        <h3>Um verkefnið</h3>
        <p>Vefsíðan er byggð á <a className="footer-link" href="https://news.ycombinator.com/">Hacker News</a></p>
        <h4>Tæknistakkur</h4>
        <ul>
      ...
      <a title="Linkur á GitHub repo verkefnis" className="githubLink" href="https://github.com/Kristinn-Thor/linkasafn">
        GitHub
        <svg className="githubIcon" aria-hidden="true" focusable="false" data-icon="github-square" role="img" viewBox="0 0 448 512">
